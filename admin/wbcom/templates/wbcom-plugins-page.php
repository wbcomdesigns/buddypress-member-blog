	...
	<div class="wbcom-wrap wbcom-plugin-wrapper">    	
		<div class="wbcom_admin_header-wrapper">
			<div id="wb_admin_plugin_name">
				<?php esc_html_e( 'Themes & Extension', 'buddypress-member-blog' ); ?>
			</div>
		...
		<div class="wbcom-all-addons-plugins-wrap">	
			<div class="wbcom-bp-addons-plugins-list">
				<div class="wbcom-bp-addons-plugins-title-section">
					<ul class="wbcom-addons-plugins-links">
						<li><a href="javascript:void(0)" data-link="paid_extension" class="wbcom-addons-link-active"><?php esc_html_e( 'Paid Extension', 'buddypress-member-blog' ); ?></a></li>
						<li><a href="javascript:void(0)" data-link="free_extension"><?php esc_html_e( 'Free Extension', 'buddypress-member-blog' ); ?></a></li>
						<li><a href="javascript:void(0)" data-link="learndash_extension"><?php esc_html_e( 'LearnDash Extension', 'buddypress-member-blog' ); ?></a></li>
						<li><a href="javascript:void(0)" data-link="our_themes"><?php esc_html_e( 'Our Themes', 'buddypress-member-blog' ); ?></a></li>
					</ul>
					<a href="<?php echo esc_url( 'https://wbcomdesigns.com/plugins/' ); ?>" class="wbcom-addons-button" target="_blank"><?php esc_html_e( 'View More Extension', 'buddypress-member-blog' ); ?></a>
				</div>
				<div id="wbcom_paid_extention" class="wbcom-bp-addons-plugins-list wbcom-bp-free-addon-plugins">
					<div class="wbcom-bp-addons-plugins-title-section">
						<h4 class="wbcom-plugin-heading"><?php esc_html_e( 'Paid Extension', 'buddypress-member-blog' ); ?></h4>
						<a href="<?php echo esc_url( 'https://wbcomdesigns.com/plugins/premium-buddypress-add-ons/' ); ?>" class="wbcom-addons-button" target="_blank"><?php esc_html_e( 'View More Extension', 'buddypress-member-blog' ); ?></a>
					</div>
					...
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-moderation-pro" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-moderation-pro/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-resume-manager/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-resume-manager/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-polls" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-polls/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-private-community-pro/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-private-community-pro/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-profile-pro/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-profile-pro/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-check-ins-pro/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-check-ins-pro/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-member-blog-pro/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-member-blog-pro/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddyvendor/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddyvendor/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-statistics/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-statistics/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/who-viewed-my-profile-buddypress/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/who-viewed-my-profile-buddypress/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-friend-follow-suggestion/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-friend-follow-suggestion/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-giphy/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-giphy/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/shortcodes-for-buddypress-pro/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/shortcodes-for-buddypress-pro/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-sticky-post/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-sticky-post/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-quotes/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-quotes/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-auto-friends/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-auto-friends/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-newsfeed/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-newsfeed/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-status/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-status/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-hashtags/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-hashtags/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-profanity/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-profanity/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
				</div>
			...
			<div id="wbcom-learndash-extension" class="wbcom-bp-addons-plugins-list wbcom-bp-free-addon-plugins">
				<div class="wbcom-bp-addons-plugins-title-section">
					<h4 class="wbcom-plugin-heading"><?php esc_html_e( 'Extension for LearnDash', 'buddypress-member-blog' ); ?></h4>
					<a href="https://wbcomdesigns.com/plugins/learndash-add-ons/" class="wbcom-addons-button" target="_blank"><?php esc_html_e( 'View More Extension', 'buddypress-member-blog' ); ?></a>
				</div>
				<div class="wbcom-addon-plugins-inner-wrapper">
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-image-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/learndash-notes/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/learndash-notes/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>					
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/learndash-wpforo/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/learndash-wpforo/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/learndash-dashboard/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/learndash-dashboard/#simple-pricing" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/peepso-learndash-integration/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/peepso-learndash-integration/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
			...
			<div id="wbcom-themes-list" class="wbcom-bp-addons-plugins-list wbcom-bp-free-addon-plugins">
				<div class="wbcom-bp-addons-plugins-title-section">
					<h4 class="wbcom-plugin-heading"><?php esc_html_e( 'Our Themes', 'buddypress-member-blog' ); ?></h4>
					<a href="https://wbcomdesigns.com/themes/" class="wbcom-addons-button" target="_blank"><?php esc_html_e( 'View More Themes', 'buddypress-member-blog' ); ?></a>
				</div>
				<div class="wbcom-addon-plugins-inner-wrapper">
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-image-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/reign-buddypress-theme/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://sandbox.wbcomdesigns.com/sandbox/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get Sandbox', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddyx-pro-theme/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddyx-pro-theme/#pricing-table" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://buddyxtheme.com/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="ttps://wbcomdesigns.com/downloads/buddyx-pro-theme/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get Pro', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/knowx-theme/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://knowxtheme.com/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get Demo', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
				</div>
			...
			<div id="wbcom-free-extension" class="wbcom-bp-addons-plugins-list wbcom-bp-free-addon-plugins">
				<div class="wbcom-bp-addons-plugins-title-section">
					<h4 class="wbcom-plugin-heading"><?php esc_html_e( 'Our Free Extension', 'buddypress-member-blog' ); ?></h4>
					<a href="https://wbcomdesigns.com/plugins/buddypress/" class="wbcom-addons-button" target="_blank"><?php esc_html_e( 'View More Extension', 'buddypress-member-blog' ); ?></a>
				</div>
				<div class="wbcom-addon-plugins-inner-wrapper">
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							<h2><?php esc_html_e( 'BuddyPress Member Blog', 'buddypress-member-blog' ); ?></h2>
							<p><?php esc_html_e( 'BuddyPress Member Blog is a free plugin that allows users to create/manage their blog/posts from the profile.', 'buddypress-member-blog' ); ?></p>
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-member-blog/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-member-blog-pro/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get Pro', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							<h2><?php esc_html_e( 'BuddyPress Ads', 'buddypress-member-blog' ); ?></h2>
							<p><?php esc_html_e( 'Integrate your BuddyPress community to provide a smooth customer experience and increase site engagement.', 'buddypress-member-blog' ); ?></p>
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-ads/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-ads/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							<h2><?php esc_html_e( 'BuddyPress User Todo List', 'buddypress-member-blog' ); ?></h2>
							<p><?php esc_html_e( 'Allow users to create and manage their to-dos with the relevant category right from their profile.', 'buddypress-member-blog' ); ?></p>
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-user-to-do-list/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-user-to-do-list/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							<h2><?php esc_html_e( 'BuddyPress Job Manager', 'buddypress-member-blog' ); ?></h2>
							<p><?php esc_html_e( 'Create specific tabs in employer’s and candidate’s profiles on BuddyPress.', 'buddypress-member-blog' ); ?></p>
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-job-manager/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-job-manager/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							<h2><?php esc_html_e( 'BuddyPress Member Reviews', 'buddypress-member-blog' ); ?></h2>
							<p><?php esc_html_e( 'Allow members to provide their ratings and reviews to other members’ profiles based on multiple criteria.', 'buddypress-member-blog' ); ?></p>
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-member-reviews/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-member-reviews/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							<h2><?php esc_html_e( 'BuddyPress Birthday Widget', 'buddypress-member-blog' ); ?></h2>
							<p><?php esc_html_e( 'Display the upcoming birthdays of your BuddyPress community members.', 'buddypress-member-blog' ); ?></p>
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/buddypress-birthdays/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-member-blog' ); ?></a>
								<a href="https://wbcomdesigns.com/downloads/buddypress-birthdays/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Get It Now', 'buddypress-member-blog' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
