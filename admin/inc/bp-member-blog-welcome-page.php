	...
	<div class="wbcom-welcome-main-wrapper">
		...
		<div class="wbcom-welcome-content">
			...
			<div class="wbcom-welcome-support-info">
				...
				<p><?php esc_html_e( 'Here are all the resources you may need to get help from us. Documentation is usually the best place to start. Should you require help anytime, our customer care team is available to assist you at the support center.', 'buddypress-member-blog' ); ?></p>
				<hr>
				...
				<div class="three-col">
					...
					<div class="col">
						...
						<a href="<?php echo esc_url( 'https://wbcomdesigns.com/docs/buddypress-free-addons/buddypress-member-blog/' ); ?>" class="button button-primary button-welcome-support" target="_blank"><?php esc_html_e( 'Read Documentation', 'buddypress-member-blog' ); ?></a>
					</div>
