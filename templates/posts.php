...
?>
<?php do_action( 'bp_member_blog_before_posts' ,'publish' ); ?>
	...
	<?php if ( have_posts() ) : ?>
		...
		if ( is_user_logged_in() ) {
			if ( bp_is_my_profile() ) {
				...
				echo '<p>';
				echo sprintf( esc_html__( "%s hasn't posted anything yet.", "buddypress-member-blog" ) , esc_html( bp_get_displayed_user_fullname() ) );
				echo '</p>';
				echo '</div>';
			}
		} else {
