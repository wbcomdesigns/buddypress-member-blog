					...
					<div class="wbcom-tabs-section">
						<div class="nav-tab-wrapper">
							...
							foreach ( $member_blog_tabs as $bmpro_tab => $bmpro_name ) {
								...
								echo '<li class="' . esc_html( $bmpro_name ) . '"><a class="nav-tab ' . esc_attr( $class ) . '" href="admin.php?page=buddypress-member-blog&tab=' . esc_attr( $bmpro_tab ) . '">' . esc_html( $bmpro_name ) . '</a></li>';
							}
							?>
							</ul>
						</div>
