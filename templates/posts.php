...
<div  class="bp-member-blog-container">
		...
		while ( have_posts() ) :
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="post-content">
					...
					<?php
					/* translators: %s: */
					printf( esc_html__( '%1$s', 'buddypress-member-blog' ), get_the_date(), get_the_category_list( ', ' ) ); //phpcs:ignore
					?>
					</div>
	...
	<?php else : ?>
			<p>
				<?php
				/* translators: %s: */
				echo sprintf( "<p>%s haven't posted anything yet.</p>", bp_get_displayed_user_fullname() ); //phpcs:ignore
				?>
			</p>
	<?php endif; ?>
