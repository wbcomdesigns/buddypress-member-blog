...
class Buddypress_Member_Blog_Public {
	...
	public function buddypress_member_blog_setup_nav() {
		...
		$total_posts = apply_filters( 'bp_member_blog_visible_posts_count', $total_posts, $user_id );

		$blog_label = apply_filters( 'bp_member_change_blog_label', sprintf( __( 'Blog <span class="count">%d</span>', 'buddypress-member-blog' ), $total_posts ) );
